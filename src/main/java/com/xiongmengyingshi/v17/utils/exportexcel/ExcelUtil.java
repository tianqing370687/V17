package com.xiongmengyingshi.v17.utils.exportexcel;
...
/**
 * Created by nicholas.chi on 2018/1/22.
 */
...
//                }
                ...
                if(objValue != null || !"".equals(objValue)){
                    if(objValue instanceof  Number){
                        ...
                        fieldValue= dateTimeFormat(objValue.toString());
                        Label label =new Label(i,rowNo,fieldValue);
                        sheet.addCell(label);
                    }else {
                        fieldValue=objValue==null ? "" : objValue.toString();
    ...
    private static String dateTimeFormat(String dateStr){
