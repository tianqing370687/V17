...
CREATE TABLE `v17_personal_info` (
  ...
  `info_name` varchar(50) NOT NULL COMMENT '姓名',
  `info_birthday` datetime DEFAULT NULL COMMENT '生日',
  `info_age` int(3) NOT NULL COMMENT '年龄',
  `info_birthplace` varchar(400) NOT NULL COMMENT '出生地',
  `info_residence` varchar(200) DEFAULT NULL COMMENT '现住地',
  `info_performing_experience` varchar(1000) DEFAULT NULL COMMENT '演艺经历',
  ...
  `info_qq` bigint(11) DEFAULT NULL,
  ...
  `info_specialty` varchar(1000) DEFAULT NULL COMMENT '特长',
  `info_interest` varchar(200) DEFAULT NULL COMMENT '兴趣',
  `info_awards` varchar(1000) DEFAULT NULL COMMENT '获奖情况',
  `info_dream` varchar(1000) DEFAULT NULL COMMENT '梦想',
  ...
  `info_serial_num` char(20) DEFAULT NULL COMMENT '序列号',
...
INSERT INTO `v17_admin` VALUES ('1', 'admin', '6ea1f8b295f1dfc13bc4b7458779cb85', '61904', '2018-01-19 11:21:09', '0:0:0:0:0:0:0:1');
